...
function allrun()
    ...
    neohookean_h8()             # weird_timing_examples.neohookean_h8()
    println("#####################################################")
    println("# neohookean_h8_thr ")
    neohookean_h8_thr()             # weird_timing_examples.neohookean_h8_thr()
    println("#####################################################")
    println("# neohookean_h8_thr_2 ")
    neohookean_h8_thr_2()  
    return true
end # function allrun 

end # module weird_timing_examples
