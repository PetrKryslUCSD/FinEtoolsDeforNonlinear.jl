...
using Hyperelasticity.AlgoDeforNonlinearModule: nonlinearstatics
...
function test()
    ...
    e2 = FDataDict("node_list"=>l2, "component"=>2, "displacement"=>0.0)
    l3  = selectnode(fens; box = [-Inf,Inf,-Inf,Inf,0,0], inflate  =  tolerance)
    e3 = FDataDict("node_list"=>l3, "component"=>3, "displacement"=>0.0)
